...
// Icon placeholders using lucide-react as fallbacks
const OpenAI = ({ className }: { className?: string }) => <Bot className={className} />;
const OpenAIDark = ({ className }: { className?: string }) => <Bot className={className} />;
const Anthropic = ({ className }: { className?: string }) => <Brain className={className} />;
const AnthropicDark = ({ className }: { className?: string }) => <Brain className={className} />;
const Google = ({ className }: { className?: string }) => <Search className={className} />;
const MistralAI = ({ className }: { className?: string }) => <Cpu className={className} />;
const DeepSeek = ({ className }: { className?: string }) => <Database className={className} />;
