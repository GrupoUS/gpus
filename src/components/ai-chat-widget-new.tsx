	...
	>([
		{
			id: '1',
			content:
				'Olá! Sou o assistente IA do Grupo US. Estou aqui para iluminar seu caminho na saúde estética. Como posso ajudar você hoje?',
			sender: 'ai',
			timestamp: new Date(),
		},
	]);
	...
	const handleEscalate = () => {
		setMessages((prev) => [
			...prev,
			{
				id: Date.now().toString(),
				content:
					'Entendido. Vou transferir sua conversa para um de nossos especialistas humanos. Eles entrarão em contato em breve. Por favor, aguarde.',
				sender: 'bot',
				timestamp: new Date(),
			},
		]);
