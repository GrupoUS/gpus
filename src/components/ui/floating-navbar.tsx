		...
		<AnimatePresence mode="wait">
			...
			>
				<Link to="/sign-in">
					...
					>
						<RippleButton
							className="bg-transparent hover:bg-transparent text-transparent bg-clip-text bg-linear-to-r from-amber-200 to-yellow-400 font-bold px-8 py-2 text-lg hover:scale-105 transition-transform"
