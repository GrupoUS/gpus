...
export class AsaasClient {
  ...
  public async testConnection(): Promise<{ status: number; success: boolean }> {
    try {
      await this.fetch<{ object: string; totalCount: number }>(
        "/customers?limit=1",
      );
      ...
      console.error(
        "[AsaasClient] Connection test failed:",
  ...
  public async createCustomer(
    ...
    try {
      ...
      const classified = classifyError(error);
      console.error(
        "[AsaasClient] createCustomer failed:",
        sanitizeErrorForLogging(error),
      );
      throw classified;
    }
  ...
  public async updateCustomer(
    ...
    try {
      return await this.fetch<AsaasCustomerResponse>(
      ...
      const classified = classifyError(error);
      console.error(
        "[AsaasClient] updateCustomer failed:",
        sanitizeErrorForLogging(error),
      );
      throw classified;
    }
  ...
  public async getCustomer(customerId: string): Promise<AsaasCustomerResponse> {
    try {
      ...
      const classified = classifyError(error);
      console.error(
        "[AsaasClient] getCustomer failed:",
        sanitizeErrorForLogging(error),
      );
      throw classified;
    }
  ...
  public async listAllCustomers(params?: {
    ...
    try {
      ...
      const classified = classifyError(error);
      console.error(
        "[AsaasClient] listAllCustomers failed:",
        sanitizeErrorForLogging(error),
      );
      throw classified;
    }
  ...
  public async createPayment(
    ...
    try {
      ...
      const classified = classifyError(error);
      console.error(
        "[AsaasClient] createPayment failed:",
        sanitizeErrorForLogging(error),
      );
      throw classified;
    }
  ...
  public async getPixQrCode(
    ...
    try {
      ...
      const classified = classifyError(error);
      console.error(
        "[AsaasClient] getPixQrCode failed:",
        sanitizeErrorForLogging(error),
      );
      throw classified;
    }
  ...
  public async createSubscription(
    ...
    try {
      ...
      const classified = classifyError(error);
      console.error(
        "[AsaasClient] createSubscription failed:",
        sanitizeErrorForLogging(error),
      );
      throw classified;
    }
  ...
  public async listAllPayments(params?: {
    ...
    try {
      ...
      const classified = classifyError(error);
      console.error(
        "[AsaasClient] listAllPayments failed:",
        sanitizeErrorForLogging(error),
      );
      throw classified;
    }
  ...
  public async listAllSubscriptions(params?: {
    ...
    try {
      ...
      const classified = classifyError(error);
      console.error(
        "[AsaasClient] listAllSubscriptions failed:",
        sanitizeErrorForLogging(error),
      );
      throw classified;
    }
  ...
  public async getFinancialSummary(params?: {
    ...
    try {
      ...
      const classified = classifyError(error);
      console.error(
        "[AsaasClient] getFinancialSummary failed:",
        sanitizeErrorForLogging(error),
      );
      throw classified;
    }
