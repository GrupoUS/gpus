...
export const brevoContacts = {
	...
	async update(
		email: string,
		payload: Omit<BrevoContactPayload, 'email'>,
	): Promise<void> {
	...
	async get(
		...
		const id =
			typeof identifier === 'number' ? identifier : encodeURIComponent(identifier)
...
export const brevoCampaigns = {
	...
	async update(
		campaignId: number,
		payload: Partial<BrevoCampaignPayload>,
	): Promise<void> {
	...
	async getStats(campaignId: number): Promise<BrevoCampaignStats> {
		return brevoFetch<BrevoCampaignStats>(
...
export const brevoTemplates = {
	...
	async update(
		templateId: number,
		payload: Partial<BrevoTemplatePayload>,
	): Promise<void> {
