...
export const validationSchemas = {
	...
	marketingLead: z.object({
		...
		interest: z.enum(['Harmonização Facial', 'Estética Corporal', 'Bioestimuladores', 'Outros']),
...
export class RateLimiter {
	...
	isAllowed(key: string): boolean {
		...
		// Clean old attempts
		const recentAttempts = attempts.filter((timestamp) => timestamp > now - this.windowMs);
